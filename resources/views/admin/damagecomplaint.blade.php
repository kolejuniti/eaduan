...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 col-sm-12 col-12">
            <div class="card mb-3">
                <form method="POST" action="{{ route('admin.damagecomplaint') }}">
                    @csrf
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.open-modal', function() {
            ...
            $.ajax({
                url: "{{ route('admin.damagecomplaint.detail') }}",  // Ensure the route is correct
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id
                ...
                success: function(response) {
                    if (response.complaintLists) {
                        ...
                        if (complaintData) {
                            ...
                            if (complaintData.date_of_completion === null) {
                                $('#save-container').html(`
                                    <div class="modal-footer">
