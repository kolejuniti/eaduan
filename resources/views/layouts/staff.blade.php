            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        @else
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('staff.dashboard') }}"><i class="bi bi-house"></i>&nbsp;Home</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="{{ route('staff.damageform') }}">Kerosakan</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('staff.generalform') }}">Umum</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="{{ route('staff.damagereport') }}">Kerosakan</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('staff.generalreport') }}">Umum</a>
                                </li>
                            </ul>
                        </li>
                        @endguest
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <i class="bi bi-person-circle"></i>&nbsp;{{ Auth::guard('staff')->user()->name }}
                                </a>
