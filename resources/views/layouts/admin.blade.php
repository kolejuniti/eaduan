                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.user') }}">Pegawai</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.damagecomplaint') }}">Kerosakan</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.generalcomplaint') }}">Umum</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.damageReport') }}">Kerosakan</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.generalReport') }}">Umum</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
